...
import { createCertificateReview } from "../../../../../../../../../../services/reviews/reviews";

interface Props {
  getAll: () => void;
  toggleCertificateReviewsForm: () => void;
  certificateId: number;
}

const AdminCertificateReviewsForm: React.FC<Props> = ({
  toggleCertificateReviewsForm,
  getAll,
  certificateId,
}) => {
  ...
  return (
    ...
    >
      ...
      <div className={styles.admin__block_actions}>
        ...
        <button
          onClick={toggleCertificateReviewsForm}
          className={styles.admin__actions_button}
          type="button"
          disabled={isLoading}
        >
...
export default AdminCertificateReviewsForm;
