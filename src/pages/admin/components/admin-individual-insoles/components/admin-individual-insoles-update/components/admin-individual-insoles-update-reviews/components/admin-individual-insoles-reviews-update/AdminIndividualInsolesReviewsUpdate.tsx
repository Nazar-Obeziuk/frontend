...
const AdminIndividualInsolesReviewsUpdate: React.FC = () => {
    ...
    const getEditedProductReview = async () => {
      try {
        ...
        if (editedProductReview) {
          const updatedObject = {
            stars: editedProductReview.stars,
            name_ua: editedProductReview.name_ua,
            name_en: editedProductReview.name_en,
            description_ua: editedProductReview.description_ua,
            description_en: editedProductReview.description_en,
            pluses_ua: editedProductReview.pluses_ua,
            pluses_en: editedProductReview.pluses_en,
            minuses_ua: editedProductReview.minuses_ua,
            minuses_en: editedProductReview.minuses_en,
          };
        ...
        <div className={styles.admin__update_wrapper}>
          <div className={styles.admin__wrapper_route}>
            ...
            <p
              className={`${styles.admin__router_name} ${styles.admin__router_active}`}
            >
              Редагування відгука продукта
            </p>
          </div>
          <h2 className={styles.admin__wrapper_title}>
            Оновлення даних відгука продукта
          </h2>
...
export default AdminIndividualInsolesReviewsUpdate;
