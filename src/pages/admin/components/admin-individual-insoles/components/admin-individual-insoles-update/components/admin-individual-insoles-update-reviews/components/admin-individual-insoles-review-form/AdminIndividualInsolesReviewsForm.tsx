...
import { createIndividualReview } from "../../../../../../../../../../services/reviews/reviews";

interface Props {
  getAll: () => void;
  toggleProductReviewsForm: () => void;
  individualId: number;
}

const AdminIndividualInsolesReviewsForm: React.FC<Props> = ({
  toggleProductReviewsForm,
  getAll,
  individualId,
}) => {
  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      if (token) {
        const response = await createIndividualReview(formData, individualId);
  ...
  return (
    ...
    >
      ...
      <div className={styles.admin__block_actions}>
        ...
        <button
          onClick={toggleProductReviewsForm}
          className={styles.admin__actions_button}
          type="button"
          disabled={isLoading}
        >
...
export default AdminIndividualInsolesReviewsForm;
