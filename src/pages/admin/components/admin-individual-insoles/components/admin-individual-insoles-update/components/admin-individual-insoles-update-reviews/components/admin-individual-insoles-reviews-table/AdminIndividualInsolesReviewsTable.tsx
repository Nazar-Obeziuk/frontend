...
import styles from "./AdminIndividualInsolesReviewsTable.module.css";
...
const AdminIndividualInsolesReviewsTable: React.FC<Props> = ({
  productReviews,
  getAll,
}) => {
...
export default AdminIndividualInsolesReviewsTable;
